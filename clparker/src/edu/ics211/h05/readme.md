...
#### 2\. Create a class named SortableList that implements the [IList211](IList211.java) and [ISortableList](ISortableList.java) interfaces
...
#### 4\. Create a SortedCloudList that implements [IList211](IList211.java) and automatically sorts the list of Clouds
...
We are going to use the [SortedCloudListTest.java](SortedCloudListTest2.java) JUnit tests to evaluate your **SortedList** class for correctness.
...
2.  Does your code pass the [JUnit Tests](SortedCloudListTest2.java)?
3.  Export your project following the [instructions](../030.oop/experience-H02-clouds#turning-in-the-assignment) at the bottom of the page. Name the file H05.zip
4.  Sign into Laulima, then navigate to the ICS211 site. In the left hand side of the site, there is an Assignments tab/link. Click on it and view all of the posted assignments. Select the assignment that you want to turn in and attach your H05.zip file accept the honor pledge to submit the assignment.

Carleton (Cam) Moore | Information and Computer Sciences | University of Hawaii, Manoa  
[\[email protected\]](/cdn-cgi/l/email-protection#9efdf3f1f1ecfbdef6ffe9fff7f7b0fbfaeb)  
