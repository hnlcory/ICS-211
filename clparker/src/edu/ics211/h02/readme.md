...
The Cloud hierarchy looks like ![Cloud Heirarchy](CloudHeirarchy.png).

This assignment will give you practice using Eclipse to create and test Java classes. Hopefully, you have set up your [Eclipse environment](/ics211s21/morea/020.java/experience-environment-configuration.html) to make this assignment easier to complete.
...
The Java files you need are: [MotherNatureTest.java](MotherNatureTest.java), [CloudCreator.java](CloudCreator.java), and [CloudShape.java](CloudShape.java).
...
![New Cloud Class](NewCloudClass.png)
...
![Cloud Class](CloudClass.png)

Modify the base _abstract_ class **Cloud** so that it has:

*   A private Integer member variable called altitude.
*   A private [CloudShape](CloudShape.java) member variable called shape.
...
Here’s a screen shot of my **Cloud** class in Eclipse. ![Cloud class](CloudClass2.png)
...
Create a **MotherNature** singleton class that can create Clouds. Singleton classes have a static method **getInstance()** that returns the one and only one instance of the class. The class must implement the [**CloudCreator**](CloudCreator.java) interface.

Here’s a screen shot of my **MotherNature** class.

![MotherNature](MotherNatureClass.png)
...
At this point you can test your code with [MotherNatureTest.java](MotherNatureTest.java). We are going to use the JUnit tests to evaluate your homework for correctness.
...
You can test your comparators using [CloudComparatorTest.java](CloudComparatorTest.java).
...
*   Does your code pass the [JUnit Tests](MotherNatureTest.java)?
*   Export your project by choosing File -> Export. Under General choose Archive File.
    
    ![Export Dialog](Export.png)
...
*   Sign into Laulima, then navigate to the ICS211 site. In the left hand side of the site, there is an Assignments tab/link. Click on it and view all of the posted assignments. Select the assignment that you want to turn in and attach your H02.zip file and accept the honor pledge to submit the assignment. Yes, the pledge says you worked alone, but in ICS 211 you can work together as long as you give credit to you teammates. See the [Giving Credit](/ics211s21/morea/010.introduction/sc-giving-credit.html) screen cast.

Carleton (Cam) Moore | Information and Computer Sciences | University of Hawaii, Manoa  
[\[email protected\]](/cdn-cgi/l/email-protection#fa99979595889fba929b8d9b9393d49f9e8f)  
